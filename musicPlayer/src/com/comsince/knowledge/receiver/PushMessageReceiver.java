package com.comsince.knowledge.receiver;
...
public class PushMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (intent.getAction().equals(PushConstants.ACTION_MESSAGE)) {
			 ...
			 * Intent(Constant.ACTION_MESSAGE);
			 * responseIntent.putExtra(Constant.EXTRA_MESSAGE, message);
			...
			aIntent.setClass(context, MusicPlayActivity.class);
