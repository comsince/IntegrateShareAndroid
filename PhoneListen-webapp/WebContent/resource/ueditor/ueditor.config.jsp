...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"<%=serverPath %>/system/system_imageUpload.action"             //图片上传提交地址
        ...
        ,maxImageSideLength:720                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        , toolbars: [["link","unlink","undo","redo","insertimage","emotion","fontfamily","fontsize","forecolor","bold","italic","underline","strikethrough","justifyleft","justifycenter","justifyright","justifyjustify","imageright","autotypeset","preview","fullscreen"]]
...
//           ]
        ...
        //快捷菜单
        //,shortcutMenu:["fontfamily","fontsize","bold","italic","underline","forecolor"]
