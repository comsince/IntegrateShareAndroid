...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="web-app ui-selectable">
		...
		<div id="mainWrapper">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="padding: 5px;">
					<form action="<%=basePath%>/admin/record_locationManage.action" method="post"
									...
									<tr id="${record.gid}">
										...
										<td>
											...
											<div class="btn-group btn-group-xs">
											  <button type="button" class="btn btn-default" style="padding: 5px;" onclick="showDetailDialog(${record})">查看</button>
		...
		<script>
		       $('#locManageMenu').addClass('current');
